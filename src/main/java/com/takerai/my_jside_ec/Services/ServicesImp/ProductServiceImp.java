package com.takerai.my_jside_ec.Services.ServicesImp;
...
import com.takerai.my_jside_ec.Repositories.ProductRepository;
...
public class ProductServiceImp implements ProductService {
    ...
    @Override
    public Page<Product> getRequestFilters(
        int page,
        int limit,
        String productName,
    ...
    private Page<Product> findProductsByNameAndOrderByPrice(
        int page,
        int limit,
        String productName,
        Sort.Direction sortType
